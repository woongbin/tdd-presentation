...
class PointServiceUnitTest extends TestCase
{
    ...
    /** @test */
    public function 이벤트기간_2022년_3월에는_2배의_포인트를_제공한다(): void
    {
        $testParameters = [];
        $testParameters[] = ['price' => 10000, 'pointRate' => 0.1, 'result' => 2000];
        $testParameters[] = ['price' => 10000, 'pointRate' => 0.05, 'result' => 1000];
        $testParameters[] = ['price' => 10000, 'pointRate' => 0.07, 'result' => 1400];
        $testParameters[] = ['price' => 8300, 'pointRate' => 0.1, 'result' => 1660];
